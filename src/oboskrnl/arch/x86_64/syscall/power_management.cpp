...
namespace obos
{
    ...
    namespace syscalls
    {
        ...
        void SyscallReboot()
        {
            ...
            // Keep this code as a souvenir of when uACPI didn't have a reboot helper.
            // Funny how I (Omar Berrow) was the first adopter of uACPI, even before the actual developer of uACPI (8infy).
            uacpi_reboot();
