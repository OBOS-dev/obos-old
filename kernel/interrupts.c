...
#pragma region Interrupt service routines function definitons.
extern void isr0();
extern void isr1();
extern void isr2();
extern void isr3();
...
static void _setIdtEntry(UINT8_T index, UINT32_T base, UINT16_T sel, UINT8_T flags)
{
	...
	// TODO: Un-comment "| 0x60" when user mode becomes supported.
	idtEntries[index].flags = flags /* | 0x60 */;
}

#define _setInterruptHandler(interrupt) _setIdtEntry(interrupt, (UINT32_T)isr##interrupt, 0x08, 0x8E)
